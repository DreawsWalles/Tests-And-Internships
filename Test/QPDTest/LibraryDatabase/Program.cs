...
namespace LibraryDatabase
{
    public class Program
    {
        ...
        static void WorkWithCommands(string command, ref Library library)
        {
            Console.Clear();
            switch (command)
            {
        ...
        static bool InputJournal(ref Journal journal, ref Library library)
        {
            Console.Clear();
        ...
        static bool InputField(string message, ref int field, ref Library library)
        {
            Console.Clear();
            int check;
        ...
        static bool InputField(string message, ref string field, ref Library library)
        {
            Console.Clear();
            Console.WriteLine(message);
            Console.Write("-> ");
        ...
        static bool InputBook(ref Book book, ref Library library)
        {
            Console.Clear();
            string fieldString = null;
            int fieldInt = 0;
        ...
        static void AddNode(ref Library library)
        {
            Console.Clear();
        ...
        static Journal ChoiceJournal(ref Library library)
        {
            Console.Clear();
        ...
        static Book ChoiceBook(ref Library library)
        {
            Console.Clear();
            if (library.CountBooks < 0)
            {
        ...
        static int ChoiceCount(Book book, ref Library library)
        {
            Console.Clear();
            Menu menu = new Menu("Выберите действие:", commands);
            menu.Add("Повторить ввод");
                ...
                if (check < 0)
                {
                    switch (check)
                    {
                        ...
                        case -2:
                            ...
                            break;
                        case -3:
                            Console.WriteLine($"Введенное значение должно быть в диапазоне [0; {book.Count}]");
                            break;
                    }
                    menu.Print();
                    switch (menu.Choice())
        ...
        static int ChoiceCount(Journal journal, ref Library library)
        {
            Console.Clear();
            Menu menu = new Menu("Выберите действие:", commands);
            menu.Add("Повторить ввод");
                ...
                if (check < 0)
                {
                    switch (check)
                    {
                        ...
                        case -2:
                            ...
                            break;
                        case -3:
                            Console.WriteLine($"Введенное значение должно быть в диапазоне [0; {journal.Count}]");
                            break;
                    }
                    menu.Print();
                    switch (menu.Choice())
        ...
        static void RemoveNode(ref Library library)
        {
            Console.Clear();
        ...
        static bool Change(Book book, ref int indexField, ref int fieldInt, ref string fieldString, ref Library library)
        {
            Console.Clear();
        ...
        static bool Change(Journal journal, ref int indexField, ref int fieldInt, ref string fieldString, ref Library library)
        {
            Console.Clear();
            Menu menu = new Menu("Выберите параметр для изменения", commands);
        ...
        static void ChangeNode(ref Library library)
        {
            Console.Clear();
        ...
        static void Search(ref Library library)
        {
            Console.Clear();
        ...
        static void Print(ref Library library)
        {
            Console.Clear();
        ...
        {
            Menu menu = new Menu("Работа библиотеки на базе данных", commands);

...
namespace WebBot.Models
{
    ...
    {
        public static Dictionary<string, string> Hellows = new Dictionary<string, string>
        {
        ...
        public static Dictionary<int, string> Jokes = new Dictionary<int, string>
        {
        ...
        public static Dictionary<int, string> Aphorisms = new Dictionary<int, string>
        {
